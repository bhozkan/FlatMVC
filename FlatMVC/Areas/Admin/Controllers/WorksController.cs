...
namespace FlatMVC.Areas.Admin.Controllers
{
    public class WorksController : AdminController
    {
        ...
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "Id,ImageURL,Title,ShortDesc,LongDesc")] Work work, HttpPostedFileBase ImageFile)
        {
            if(ImageFile != null && ImageFile.ContentLength != 0)
            {
                var path = Server.MapPath("/Content/Works/");
